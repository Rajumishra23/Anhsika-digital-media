    ...
    <section className="py-6 bg-white dark:bg-gray-950">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Text Section */}
          <div>
            <span className="inline-block bg-purple-100 border border-[#652f8e] text-[#652f8e] text-sm font-semibold px-4 py-1 rounded-full mt-5 mb-4">
              About Us
            </span>
            <h2 className="text-4xl font-extrabold text-gray-900 dark:text-white leading-snug mb-6">
              Building Creative Careers Since{" "}
              <span className="text-[#652f8e]">2018</span>
            </h2>
            <p className="text-base text-gray-700 dark:text-gray-300 mb-5 leading-relaxed">
              <strong className="text-gray-900 dark:text-white">Anshika Digital Media</strong> is a Pvt. Ltd. company and a leading training institute for Digital Marketing, Graphic Designing, UI/UX, and Video Editing. Established in 2018 by{" "}
              <strong className="text-gray-900 dark:text-white">Ankit KK</strong>, the company has grown to become a hub for creative professionals.
            </p>
            ...
            <a
              href="#"
              className="inline-block bg-[#652f8e] text-white px-6 py-3 rounded-full text-sm font-semibold shadow hover:bg-[#582673] transition duration-300"
            >
              Learn More
            </a>
          </div>
