      ...
      <div className="max-w-7xl mx-auto px-1 md:px-4 flex items-center justify-between">
        ...
        <div className="hidden md:block relative w-full max-w-sm mx-6">
          ...
          <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="absolute right-3 top-2.5 text-gray-100 w-4 h-4"
          >
    ...
    <path d="M6 9l6 6 6-6" />
            ...
            {dropdownOpen && (
              <div className="absolute top-full left-0 bg-white text-gray-800 rounded-md shadow-md mt-2 w-48 z-50">
                <Link
                  to="/graphic-design-course"
                  className="block px-4 py-2 hover:bg-purple-100"
                >
                  Graphic Designing
                </Link>
                <Link
                  to="/video-editing-course"
                  className="block px-4 py-2 hover:bg-purple-100"
                >
                  Video Editing
                </Link>
      ...
      {/* Mobile Nav Dropdown */}
      <div className="md:hidden bg-[#652f8e] px-2 shadow-md transition-all duration-300 ease-in-out max-h-0 overflow-hidden opacity-0">
