...
import StudentPortfolio from "../components/StudentPortfolio"; // Added import
      ...
      <section className="bg-black text-white py-12 px-6">
        <div className="max-w-5xl mx-auto border border-gray-500 rounded-2xl p-8 text-center">
          ...
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="lucide lucide-arrow-down-to-line" width={18} height={18} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 17V3" />
              <path d="m6 11 6 6 6-6" />
              <path d="M19 21H5" />
            </svg>
        ...
        {/* Student Portfolio Section Added */}
        <StudentPortfolio />
      </section>
      {/* Top Image Section */}
<section className="relative w-full bg-black">
<img
  src="Asset 30.svg" // replace with your uploaded image path
  alt="Graphic Design Banner"
  className="w-80 h-48 mx-auto block object-cover" // width 20rem, height 12rem, centered
/>
  ...
  <div className="max-w-4xl mx-auto px-4">
    <div className="border-2 border-[#652f8e] bg-black rounded-2xl p-6 shadow-lg bg-white text-center">
      ...
      <div className="rounded-xl overflow-hidden shadow-md mb-6">
        <img
          src="Asset 29.svg"  // Replace with actual image path
          alt="Farewell Moment"
